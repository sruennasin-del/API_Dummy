...
@section('title', 'Add Collection - ZestShop')

@section('content')
    <!-- Header -->
    <div class="row align-items-center mb-4">
        <div class="col">
            <h1 class="h3 fw-bold mb-1" style="font-family: 'Syne', sans-serif;">Add New Collection</h1>
            <p class="text-muted mb-0">Create a new product grouping.</p>
        </div>
        <div class="col-auto">
                ...
                <div class="card-premium-body">
                    <form action="{{ url('/admin/collections') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" class="form-control rounded-3 py-2.5 @error('name') is-invalid @enderror" placeholder="e.g., New Arrivals" required style="border-color: var(--border-color); font-size: 14.5px;">
                            @error('name')
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="slug" id="slug" value="{{ old('slug') }}" class="form-control py-2.5 rounded-end-3 @error('slug') is-invalid @enderror" placeholder="e.g., new-arrivals (leave blank to auto-generate)" style="border-color: var(--border-color); font-size: 14.5px;">
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="description" rows="4" class="form-control rounded-3 py-2.5 @error('description') is-invalid @enderror" placeholder="Describe this collection..." style="border-color: var(--border-color); font-size: 14.5px;">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
