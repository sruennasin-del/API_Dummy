...
@section('title', 'Edit Size - ZestShop')

@section('content')
    <!-- Header -->
    <div class="row align-items-center mb-4">
        <div class="col">
            <h1 class="h3 fw-bold mb-1" style="font-family: 'Syne', sans-serif;">Edit Size</h1>
            <p class="text-muted mb-0">Modify the details of size variation: {{ $size->name }}.</p>
        </div>
        <div class="col-auto">
                ...
                <div class="card-premium">
                    ...
                    <div class="card-premium-body">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $size->name) }}" class="form-control rounded-3 py-2.5 @error('name') is-invalid @enderror" placeholder="e.g., S, M, L, XL, 38, 40" required style="border-color: var(--border-color); font-size: 14.5px;">
                            @error('name')
            ...
            <div class="col-lg-4">
                ...
                <div class="d-grid gap-2">
                    <button type="submit" class="btn btn-warning text-white rounded-pill py-2.5 fw-bold" style="background-color: var(--primary); border-color: var(--primary); font-size: 15px;">
                        <i class="ti ti-circle-check me-1"></i> Update Size
                    </button>
