            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span class="badge bg-light text-dark border px-2 py-1" style="font-family: monospace; font-size: 11px; letter-spacing: 0.5px;"
                            title="Courier: {{ $order->courier }}">
                    ...
                    <td>
                        ...
                        <form action="{{ url('/admin/orders/' . $order->id) }}" method="POST" class="quick-status-form">
                            @csrf
                            @method('PUT')
