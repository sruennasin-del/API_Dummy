...
@section('title', 'Add User - ZestShop')

@section('content')
    <!-- Header -->
    <div class="row align-items-center mb-4">
        <div class="col">
            <h1 class="h3 fw-bold mb-1" style="font-family: 'Syne', sans-serif;">Add New User</h1>
            <p class="text-muted mb-0">Create a new system user or customer account.</p>
        </div>
        <div class="col-auto">
                ...
                <div class="card-premium">
                    ...
                    <div class="card-premium-body">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" class="form-control rounded-3 py-2.5 @error('name') is-invalid @enderror" placeholder="e.g., John Doe" required style="border-color: var(--border-color); font-size: 14.5px;">
                            @error('name')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="email" name="email" id="email" value="{{ old('email') }}" class="form-control rounded-3 py-2.5 @error('email') is-invalid @enderror" placeholder="e.g., john.doe@example.com" required style="border-color: var(--border-color); font-size: 14.5px;">
                            @error('email')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <!-- Password -->
                        <div class="mb-4">
                            <label for="password" class="form-label fw-semibold text-dark fs-6">Password <span class="text-danger">*</span></label>
                            <input type="password" name="password" id="password" class="form-control rounded-3 py-2.5 @error('password') is-invalid @enderror" placeholder="Minimum 8 characters" required style="border-color: var(--border-color); font-size: 14.5px;">
                            @error('password')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <!-- Confirm Password -->
                        <div class="mb-4">
                            <label for="password_confirmation" class="form-label fw-semibold text-dark fs-6">Confirm Password <span class="text-danger">*</span></label>
                            <input type="password" name="password_confirmation" id="password_confirmation" class="form-control rounded-3 py-2.5" placeholder="Repeat the password" required style="border-color: var(--border-color); font-size: 14.5px;">
                        </div>
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-5">
                            ...
                            <button type="submit" class="btn btn-warning text-white rounded-pill px-4 py-2.5 fw-bold" style="background-color: var(--primary); border-color: var(--primary); font-size: 14.5px;">
                                <i class="ti ti-circle-check me-1"></i> Save User
                            </button>
                        </div>
                    </div>
                </div>
