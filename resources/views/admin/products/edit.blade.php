...
@section('title', 'Edit Product - ZestShop')

@section('content')
    <!-- Header -->
    <div class="row align-items-center mb-4">
        <div class="col">
            <h1 class="h3 fw-bold mb-1" style="font-family: 'Syne', sans-serif;">Edit Product</h1>
            <p class="text-muted mb-0">Modify details of catalog product: {{ $product->title }}</p>
        </div>
        <div class="col-auto">
                ...
                <div class="card-premium mb-4">
                    ...
                    <div class="card-premium-body">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title', $product->title) }}" class="form-control rounded-3 py-2.5 @error('title') is-invalid @enderror" placeholder="e.g., iPhone 15 Pro Max, Smart Watch Series 9" required style="border-color: var(--border-color); font-size: 14.5px;">
                            @error('title')
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="slug" id="slug" value="{{ old('slug', $product->slug) }}" class="form-control py-2.5 rounded-end-3 @error('slug') is-invalid @enderror" placeholder="e.g., iphone-15-pro" style="border-color: var(--border-color); font-size: 14.5px;">
                            </div>
                        ...
                        <div class="mb-2">
                            ...
                            <textarea name="description" id="description" rows="6" class="form-control rounded-3 py-2.5 @error('description') is-invalid @enderror" placeholder="Enter product specifications, features, and details..." style="border-color: var(--border-color); font-size: 14.5px;">{{ old('description', $product->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="card-premium mb-4">
                    ...
                    <div class="card-premium-body">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" step="0.01" name="price" id="price" value="{{ old('price', $product->price) }}" class="form-control rounded-3 py-2.5 @error('price') is-invalid @enderror" placeholder="0.00" required style="border-color: var(--border-color); font-size: 14.5px;">
                            @error('price')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="stock" id="stock" value="{{ old('stock', $product->stock) }}" class="form-control rounded-3 py-2.5 @error('stock') is-invalid @enderror" placeholder="0" required style="border-color: var(--border-color); font-size: 14.5px;">
                            @error('stock')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="card-premium-body">
                        ...
                        @if($product->image)
                            <div class="mb-4 text-center">
                                <label class="form-label fw-semibold text-dark fs-6 d-block text-start">Current Image</label>
                                <img src="{{ $product->image }}" alt="Preview" class="img-thumbnail rounded-3" style="max-height: 150px; object-fit: cover;">
                            </div>
                        @endif
                        ...
                        <div>
                            ...
                            <input type="text" name="image" id="image" value="{{ old('image', $product->image) }}" class="form-control rounded-3 py-2 @error('image') is-invalid @enderror" placeholder="https://example.com/product.jpg" style="border-color: var(--border-color); font-size: 13.5px;">
                            @error('image')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="d-grid gap-2">
                    <button type="submit" class="btn btn-warning text-white rounded-pill py-2.5 fw-bold" style="background-color: var(--primary); border-color: var(--primary); font-size: 15px;">
                        <i class="ti ti-circle-check me-1"></i> Update Product
                    </button>
    ...
    <script>
        $(document).ready(function() {
            ...
            function addColorCard(colorId, colorName, colorCode) {
                ...
                } else if (dbData && dbData.images) {
                    dbData.images.forEach((imgUrl, idx) => {
                        window.variantImages[colorId].push({
                            type: 'db',
                            url: imgUrl,
                            dbIndex: idx
