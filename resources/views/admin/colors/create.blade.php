...
@section('title', 'Add Color - ZestShop')

@section('content')
    <!-- Header -->
    <div class="row align-items-center mb-4">
        <div class="col">
            <h1 class="h3 fw-bold mb-1" style="font-family: 'Syne', sans-serif;">Add New Color</h1>
            <p class="text-muted mb-0">Create a new color option for product variations.</p>
        </div>
        <div class="col-auto">
                ...
                <div class="card-premium">
                    ...
                    <div class="card-premium-body">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" class="form-control rounded-3 py-2.5 @error('name') is-invalid @enderror" placeholder="e.g., Crimson Red, Ocean Blue" required style="border-color: var(--border-color); font-size: 14.5px;">
                            @error('name')
                        ...
                        <div class="mb-2">
                            ...
                            <div class="d-flex gap-2">
                                <div class="position-relative flex-grow-1">
                                    <input type="text" name="code" id="code" value="{{ old('code', '#FF6B1A') }}" class="form-control rounded-3 py-2.5 @error('code') is-invalid @enderror" placeholder="e.g., #FF6B1A" required style="border-color: var(--border-color); font-size: 14.5px; padding-left: 15px;">
                                </div>
                                <div style="width: 50px;">
                                    <input type="color" id="color_picker" value="{{ old('code', '#FF6B1A') }}" class="form-control form-control-color w-100 h-100 rounded-3 p-1" style="border-color: var(--border-color); cursor: pointer; min-height: 46px;">
                                </div>
                            </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="d-grid gap-2">
                    <button type="submit" class="btn btn-warning text-white rounded-pill py-2.5 fw-bold" style="background-color: var(--primary); border-color: var(--primary); font-size: 15px;">
                        <i class="ti ti-circle-check me-1"></i> Save Color
                    </button>
