        ...
        <div class="auth-body">
            @if(session('error'))
                <div class="alert-custom">
                    <i class="ti ti-alert-triangle-filled fs-5"></i>
            ...
            <form action="{{ url('/login') }}" method="POST">
                ...
                <div class="input-group-custom">
                    ...
                    <div class="input-wrapper">
                        <input type="email" name="email" id="email" 
                               ...
                               placeholder="john@example.com" value="{{ old('email') }}" required autocomplete="email" autofocus>
                ...
                <div class="remember-container">
                    <input type="checkbox" name="remember" id="remember" class="remember-checkbox me-2">
                    <label for="remember" style="font-size: 13.5px; color: #475569; cursor: pointer; user-select: none; font-weight: 500;">Remember me</label>
                </div>
